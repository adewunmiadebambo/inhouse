...
<html lang="en">
  <head>
    ...
    <title>In-House Hotel | Contact Us</title>
...
<!-- //w3l-header -->
<section class="w3l-breadcrumb" style="background: url(assets/images/cban.jpg) no-repeat;">
        ...
        <div class="container">
            ...
            <div class="map-iframe my-5">
                <iframe
                    ...
                    width="100%" height="500" frameborder="0" style="border: 0px; pointer-events: none;"
                ...
                <div class="cont-details">
                    <div class="cont-top">
                        ...
                        <div class="cont-right">
                            <h6>Call Us</h6>
                            <p><a href="info@inhousehotel.com">info@inhousehotel.com</a></p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        ...
                        <div class="cont-right">
                            <h6>Email Us</h6>
                            <p><a href="+(234)-800-999-8888" class="mail">+(234)-800-999-8888</a></p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        <div class="cont-left text-center">
                        ...
                        <div class="cont-right">
                            <h6>Address</h6>
                            <p>In-House Hotel, Lagos, Nigeria.</p>
                        </div>
                    </div>
                </div>
