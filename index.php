...
<html lang="en">
  <head>
    ...
    <title>In-House Hotel | Home </title>
                         ...
                         <div class="banner-info">
                             <div class="container">
                                 <div class="banner-info-bg">
                                     ...
                                     <!-- <a class="btn btn-style transparent-btn mt-sm-5 mt-4" href="#"> Our
                                         Services</a> -->
                                 </div>
                             </div>
                         </div>
	...
	<div class="container py-sm-4">
		<div class="row">
			<div class="col-lg-6 about-left mb-md-0 mb-5">
				<h3 class="title-big">Welcome to In-House Hotel</h3>
...
<div class="best-rooms py-5">
    <div class="container py-lg-5 py-sm-4">
        <h3 class="title-big text-center">Our Rooms</h3>
                ...
                <div class="maghny-grid">
                    <figure class="effect-lily">
                        ...
                        <figcaption class="w3set-hny">
                            <div>
                                <h4 class="top-text">Luxury Rooms and
                    ...
                    <div class="room-info">
                        ...
                        <ul class="mb-3">
                            ...
                            <li><span class="fa fa-bed"></span> 12sqft</li>
                        </ul>
...
<div class="quotation py-5">
	<div class="container py-xl-5 py-lg-3">
		<div class="welcome-left text-center py-md-5 py-3">
			...
			<!--<a href="#" class="btn btn-style transparent-btn mt-sm-5 mt-4 mr-2">Book Now</a>-->
